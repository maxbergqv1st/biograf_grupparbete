...
export default function BookingPage() {
  ...
  // Real data will be submitted from seat selection page, but for now we can mock it here. You can also use location.state to pass data from previous page.
const screening: ScreeningInfo = location.state?.screening ?? {
  id: 13,
...
const seats: BookingSeat[] = location.state?.seats ?? [
    {
      seatId: 32,
      seatLabel: "D5",
