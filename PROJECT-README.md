...
### V1 — `/api/v1`
Session and ACL-based dynamic REST API. Automatically generates CRUD endpoints for all database tables. Supports query parameters: `where`, `orderby`, `limit`, `offset`. See [README.md](README.md) for full documentation.
